...
function Home() {
  return (
    <div className="flex flex-col justify-center items-center px-4">
      <nav
        className="w-full text-white py-3 px-10"
        style={{ boxShadow: " 4px 4px rgba(0, 128, 128, 0.5)" }}
      >
        <h1 className="font-bold text-3xl text-teal-700">Seleby</h1>
      </nav>
      <div className="flex flex-col space-y-6 pt-20 px-5">
        ...
        <p>
          ...
          mengumumkan sebuah layanan baru: Alat Pengikut Gratis dari Seleby. Ini
          adalah layanan yang benar-benar Gratis, dan Anda dapat menggunakannya
          setiap 24 jam.
        </p>
        <p>
      ...
      <div className="flex flex-col px-5">
        ...
        <p>
          Apakah semakin sulit bagi Anda untuk menarik lebih banyak pengikut di
          media sosial? Apakah Anda ingin memiliki peringkat media sosial
        ...
        <p>
          ...
          Anda bingung tentang bagaimana ini akan membantu Anda. Berikut adalah
          semua yang perlu Anda ketahui tentang pengikut gratis.
        </p>
      </div>
      ...
      <div className="px-5">
        ...
        <p className="text-gray-600">
          Mendapatkan pengikut gratis di media sosial merupakan cara yang handal
          dan cepat untuk menjadi terkenal. Menginvestasikan banyak usaha dan
          waktu untuk mendapatkan pengikut gratis adalah cara yang dapat
          diandalkan untuk meningkatkan reputasi bisnis dan meningkatkan
          penjualan.
        </p>
        <p>
        ...
        <p>
          Para pengiklan selalu mencari cara untuk mencapai pasar baru. Memiliki
          lebih banyak pengikut akan menjadikan Anda seorang influencer.
        </p>
      </div>
    </div>
  );
